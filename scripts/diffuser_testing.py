...
im = Image.open("/home/naxos2-raid25/kneel027/home/kneel027/tester_scripts/dog.png")
w, h = 425, 425  # resize to integer multiple of 64
...
imvar_test = imvar_model(im, guidance_scale=3)[0][0]
only_image = im_model.reconstruct(c=image_embed, strength=1.0, guidance_scale=3)
...
only_image.save("/home/naxos2-raid25/kneel027/home/kneel027/tester_scripts/only_image2.png")
imvar_test.save("/home/naxos2-raid25/kneel027/home/kneel027/tester_scripts/imvar_test.png")
