...
class Stochastic_Search_Statistics():
    ...
    def autoencoded_brain_samples(self, subject = 1):
        ...
        x_test_ae = torch.zeros((25, x_test.shape[2]))
        
        for i in tqdm(range(25), desc = "Autoencoding samples and averaging" ):
            repetitions = []
            for j in range(3):
...
def main():
    ...
    SCS.create_dataframe_paper("Brain Diffuser regen", subject=1)
