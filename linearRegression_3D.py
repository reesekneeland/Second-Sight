...
class VectorMapping():
    def __init__(self, vector):
        ...
        # self.model = model = LinearRegression(self.vector)
    ...
    def load_data_roi(self):
        ...
        y_train = torch.empty((25500, self.datasize))
        y_test = torch.empty((2250, self.datasize))
    ...
    #                     (epoch + 1, i + 1, running_loss / 22500))
