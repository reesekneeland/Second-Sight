...
def main(decode, encode):
    ...
    if(decode):
        ...
        reconstructNImages(experiment_title="cc3m top 5 comparison MSE",
...
def reconstructNImages(experiment_title, idx):
    ...
    # outputs_c_i = predictVector_cc3m(model="410_model_c_img_0.pt", vector="c_img_0", x=x_test)
    ...
    outputs_c_i = torch.load("/home/naxos2-raid25/kneel027/home/kneel027/Second-Sight/latent_vectors/410_model_c_img_0.pt/c_img_0_cc3m_library_preds_MSE.pt")
